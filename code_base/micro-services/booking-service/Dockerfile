...
WORKDIR /open-desk/backend/booking-service
...
ARG DEPENDENCY=/open-desk/backend/booking-service/target/dependency
...
ENTRYPOINT ["java","-cp","app:app/lib/*","github.opendesk.bookingservice.BookingServiceApplication"]